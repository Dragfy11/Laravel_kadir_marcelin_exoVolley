...
<div class="container">
    <div class="text-center">
        ...
        <h1 class="titre text-danger pt-5 pb-5" style="font-size: 70px">Dashboard</h1>
        ...
        <div class="text-white text-center">
            ...
            <h1 class="titre2 pt-5 pb-5">4 joueurs avec equipe au hasard</h1>
        ...
        <div class="text-white text-center">
            ...
            <h1 class="titre2 pt-5 pb-5">2 équipes non remplies au hasard</h1>
        ...
        <div class="text-white text-center">
            ...
            <h1 class="titre2 pt-5 pb-5"> Pays EUROPE</h1>
        ...
        <div class="text-white text-center">
            ...
            <h1 class="titre2 pt-5 pb-5"> Pays HORS EUROPE</h1>
